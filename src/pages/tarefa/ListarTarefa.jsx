      ...
      <Card>
        ...
        <CardContent>
          <TableContainer component={Paper}>
            ...
            >
              ...
              <TableBody>
                {tarefas.length > 0 ? tarefas.map((row, indice) => (
                  <TableRow
                    key={indice}
        ...
        <CardActions>
          <Button style={{
            ...
            color: "#000",
            marginLeft: "10px",
          }} size="small" variant="contained" onClick={handleOpen}>
            Criar Tarefa
          </Button>
          <Button style={{
            border: "1px solid #1976",
            color: "#000",
